...
func (s *ServiceTestSuite) TestVerifyIncorrect() {
	tests := map[string]struct {
		...
		"signature - invalid curve": {
			...
			expectedError: "could not recover pubkey: calculated Rx is larger than curve P",
		},
...
func (s *ServiceTestSuite) TestVerifyWithChainTestnet() {
...
func (s *ServiceTestSuite) TestVerify() {
	tests := map[string]verifier.SignedMessage{
		...
		// Taken from https://github.com/btclib-org/btclib/blob/master/btclib/tests/test_bms.py
